...
------------------------------------------------------------------------------]]
return {
	title = "All Darkroom Notebook", 
	id = 'Darkroom_all_Notebook',
	items = {
		...
		'com.TiboAlberny.darkroom_notebook.cam_filter',
		'com.TiboAlberny.darkroom_notebook.cam_nd',
		'com.TiboAlberny.darkroom_notebook.cam_notes',
		'com.adobe.separator',
		...
		'com.TiboAlberny.darkroom_notebook.dev_pushpullx', 
